...
{\color{incolor}In [{\color{incolor}21}]:} \PY{o}{\PYZpc{}}\PY{k}{reload\PYZus{}ext} sql
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{o}{\PYZpc{}}\PY{k}{sql} sqlite:///base\PYZhy{}etudiant.db
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}23}]:} [('Armand A.',),
          ('Berthe B.',),
          ('Cendrine C.',),
          ('David D.',),
          ('Erwan E.',),
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}24}]:} [('table', 'Etudiant', 'Etudiant', 2, 'CREATE TABLE Etudiant (\textbackslash{}n       NumEt INTEGER PRIMARY KEY,\textbackslash{}n       NomEt VARCHAR2(255),\textbackslash{}n       Adresse VARCHAR2(1000)\textbackslash{}n)'),
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}25}]:} [('Etudiant',), ('Enseignant',), ('UE',), ('Enseigne',), ('Inscrit',)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}26}]:} [('CREATE TABLE Etudiant (\textbackslash{}n       NumEt INTEGER PRIMARY KEY,\textbackslash{}n       NomEt VARCHAR2(255),\textbackslash{}n       Adresse VARCHAR2(1000)\textbackslash{}n)',)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}27}]:} [('CREATE TABLE Enseignant (\textbackslash{}n       NumEns INTEGER PRIMARY KEY,\textbackslash{}n       NomEns VARCHAR2(255)\textbackslash{}n)',)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}28}]:} [('CREATE TABLE UE (\textbackslash{}n       NumUE INTEGER PRIMARY KEY,\textbackslash{}n       Titre VARCHAR2(255),\textbackslash{}n       HCours FLOAT,\textbackslash{}n       HTD FLOAT,\textbackslash{}n       HTP FLOAT\textbackslash{}n)',)]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}30}]:} [('CREATE TABLE Inscrit (\textbackslash{}n       NumEt INTEGER REFERENCES Etudiant(NumEt),\textbackslash{}n       NumUE INTEGER REFERENCES UE(NumUE),\textbackslash{}n       PRIMARY KEY (NumEt,NumUE)\textbackslash{}n)',)]
\end{Verbatim}
...
Donner les titre des UEs dans l'ordre alphabétique
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}31}]:} [('Algebre',),
          ('Algorithmique',),
          ('Analyse',),
          ('Bases de donnes',),
          ('Programmation',),
...
par groupe est au moins 46
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}32}]:} [('Algorithmique',), ('Bases de donnes',)]
\end{Verbatim}
...
Donner les noms des étudiants qui ont 'Albert A.' comme enseignant.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}33}]:} [('David D.',), ('Gerald G.',), ('Jacques J.',)]
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}35}]:} [('Bases de donnes', 18.0), ('Analyse', 25.0), ('Algebre', 25.0)]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}36}]:} [('Bertrand B.',)]
\end{Verbatim}
            
    Plutot :

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}37}]:} [('Bertrand B.',)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}38}]:} [('Bertrand B.',)]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}39}]:} [('Albert A.', 'Analyse'),
          ('Albert A.', 'Algebre'),
          ('Bertrand B.', 'Analyse'),
          ('Bertrand B.', 'Algebre'),
...
l'université. On nommera TOTAL\_HEURES ce nombre.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}40}]:} [(436.0,)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
         
         SELECT 
         UE.NumUE, SUM(HCours * NCours + HTD * NTD + HTP * NTP) AS TOTAL\PYZus{}HEURES
         FROM 
         UE
         JOIN Enseigne
         ON UE.NumUE = Enseigne.NumUE
...
\begin{quote}
A part les effects de l'implicit du NATURAL\ldots{} question de goût. Ya
un argument en faveur toutefois : c'est que ça colle mieux avec la
théorie du modèle relationnel et l'opérateur de jointure (\(\bowtie\) en
LaTeX)
\end{quote}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
         
         SELECT 
         UE.NumUE, COALESCE(SUM(HCours * NCours + HTD * NTD + HTP * NTP), 0) AS TOTAL\PYZus{}HEURES
         FROM 
         UE
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}42}]:} [(1, 70.0), (2, 70.0), (3, 75.0), (4, 95.0), (5, 126.0), (6, 0)]
\end{Verbatim}
...
donnant ce résultat).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}43}]:} [(2,)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}45}]:} [(3,)]
\end{Verbatim}
...
appellera NB\_ETUDIANTS l'attribut donnant ce nombre).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}46}]:} [(3,)]
\end{Verbatim}
...
MOY\_TP celle des TPs.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}47}]:} [(16.5, 16.333333333333332, 8.333333333333334)]
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}48}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
         ...
         SELECT
         SUM(HCours)/(SELECT COUNT(*) FROM UE WHERE HCours \PYZlt{}\PYZgt{} 0) AS MOY\PYZus{}COURS, 
         SUM(HTD)/(SELECT COUNT(*) FROM UE WHERE HTD \PYZlt{}\PYZgt{} 0) AS   MOY\PYZus{}TD, 
         SUM(HTP)/(SELECT COUNT(*) FROM UE WHERE HTP \PYZlt{}\PYZgt{} 0)AS   MOY\PYZus{}TP
         FROM
         UE ;
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}48}]:} [(16.5, 19.6, 12.5)]
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}49}]:} [(1, 'Analyse', 20.0, 25.0, 0.0),
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}50}]:} [(1117, 185.0),
          (1111, 149.0),
          (1114, 143.0),
          (1119, 135.0),
          (1112, 104.0),
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}51}]:} [(1117, 185.0),
          (1111, 149.0),
          (1114, 135.0),
          (1119, 135.0),
          (1112, 104.0),
...
{\color{incolor}In [{\color{incolor}52}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
         ...
         SELECT 
         Enseigne.NumEns, SUM(HCours) AS HEURES\PYZus{}COURS
         FROM 
         UE
         JOIN Enseigne
         ON UE.NumUE = Enseigne.NumUE
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}52}]:} [(111, 40.0), (112, 40.0), (114, 53.0), (115, 53.0)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}53}]:} [(111, 'Albert A.', 40.0),
          (112, 'Bertrand B.', 40.0),
          (114, 'David D.', 53.0),
          (115, 'Edgar E.', 53.0)]
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}54}]:} [(1, 'Analyse', 20.0, 25.0, 0.0, 111, 1, 1, 1, 0, 111, 'Albert A.'),
...
\subsection{Sandbox}\label{sandbox}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}55}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}55}]:} [(111, 1, 45.0),
          (111, 2, 25.0),
          (112, 1, 25.0),
          (112, 2, 45.0),
          (113, 3, 45.0),
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}56}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}56}]:} [(111, 1, 20.0),
          (111, 2, 0.0),
          (112, 1, 0.0),
          (112, 2, 20.0),
          (113, 3, 15.0),
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}57}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}57}]:} [(111,), (112,), (113,), (114,), (115,)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}58}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}58}]:} [(111, 50.0), (112, 50.0), (113, 33.0), (114, 33.0), (115, 33.0)]
\end{Verbatim}
...
\subsection{Sandbox}\label{sandbox}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}59}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}59}]:} [(111,), (112,), (113,), (114,), (115,)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}60}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}60}]:} [(111, 50.0), (112, 50.0), (113, 33.0), (114, 33.0), (115, 33.0)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}61}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}61}]:} [(111, 50.0), (112, 50.0), (113, 33.0), (114, 33.0), (115, 33.0)]
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}62}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{sql}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}62}]:} [(111, 50.0), (112, 50.0), (113, 33.0), (114, 33.0), (115, 33.0)]
\end{Verbatim}
