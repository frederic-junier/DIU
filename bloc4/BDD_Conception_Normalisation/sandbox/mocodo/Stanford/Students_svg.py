#!/usr/bin/env python
# encoding: utf-8
# Généré par Mocodo 2.3.7 le Wed, 27 May 2020 12:11:41
...
lines += u"""\n	<text x="%(x)s" y="%(y)s" fill="%(text_color)s" font-family="Verdana" font-size="12">major</text>""" % {'x': -25+x, 'y': 34.8+y, 'text_color': colors['entity_attribute_text_color']}
