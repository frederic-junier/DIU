#!/usr/bin/env python
# encoding: utf-8
# Généré par Mocodo 2.3.7 le Wed, 27 May 2020 08:41:34
...
with codecs.open('Classe_parents_geo.json') as f:
...
with codecs.open("Classe_parents.svg", "w", "utf8") as f:
    f.write(lines)
safe_print_for_PHP(u'Fichier de sortie "Classe_parents.svg" généré avec succès.')